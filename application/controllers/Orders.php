...
class Orders extends Admin_Controller 
{
	...
	*/
	public function fetchOrdersData()
	{
		...
		foreach ($data as $key => $value) {
			...
			if(in_array('viewOrder', $this->permission)) {
				$buttons .= '<a target="__blank" href="'.base_url('orders/printDiv/'.$value['id']).'" class="btn btn-default"><i class="fa fa-print"></i> In</a>';
			}

			if(in_array('updateOrder', $this->permission)) {
				$buttons .= ' <a href="'.base_url('orders/update/'.$value['id']).'" class="btn btn-default"><i class="fa fa-pencil"></i> Sửa</a>';
			}
	...
	*/
	public function create()
	{
		...
		$this->data['page_title'] = 'Thêm đơn hàng mới';
        ...
        if ($this->form_validation->run() == TRUE) {        	
        	...
        	if($order_id) {
        		$this->session->set_flashdata('success', 'đã tạo thành công');
	...
	public function printDiv($id)
	{
		...
		if($id) {
			...
			<head>
			  ...
			  <title> Hệ Thống Quản Lý Kho NamIT Pro</title>
			  ...
			  <section class="invoice">
			    ...
			    <div class="row">
			      <div class="col-xs-12">
			        <h2 class="page-header">
			          ...
			          <small class="pull-right">Ngày lên đơn: '.$order_date.'</small>
			        </h2>
			      </div>
			      <!-- /.col -->
			    </div>
			    ...
			    <div class="row invoice-info">
			      ...
			      <div class="col-sm-4 invoice-col">
			        ...
			        <b>Mã sản phẩm:</b> '.$order_data['bill_no'].'<br>
			        <b>Tên khách hàng:</b> '.$order_data['customer_name'].'<br>
			        <b>Địa chỉ:</b> '.$order_data['customer_address'].' <br />
			        <b>Số điện thoại:</b> '.$order_data['customer_phone'].'
			      </div>
			      <!-- /.col -->
			    </div>
			    <!-- /.row -->
