...
class Users extends Admin_Controller 
{
	...
	public function create()
	{
		...
		$this->form_validation->set_rules('groups', 'Nhóm', 'required');
		$this->form_validation->set_rules('username', 'Tài khoản', 'trim|required|min_length[5]|max_length[12]|is_unique[users.username]');
		$this->form_validation->set_rules('email', 'Email', 'trim|required|is_unique[users.email]');
		$this->form_validation->set_rules('password', 'Mật khẩu', 'trim|required|min_length[8]');
		$this->form_validation->set_rules('cpassword', 'Xác nhận mật khẩu', 'trim|required|matches[password]');
		...
		if($id) {
			if($this->input->post('confirm')) {
					...
					if($delete == true) {
		        		...
		        		$this->session->set_flashdata('error', 'Đã có lỗi!!!');
