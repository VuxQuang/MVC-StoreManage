          ...
          <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="date" class="col-sm-12 control-label">Ngày: <?php echo date('d/m/Y') ?></label>
                </div>
                <div class="form-group">
                  <label for="time" class="col-sm-12 control-label">Giờ: <?php echo date('h:i a') ?></label>
                </div>
                ...
                <div class="col-md-4 col-xs-12 pull pull-left">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="customer_name" name="customer_name" placeholder="Nhập tên của khách hàng" value="<?php echo $order_data['order']['customer_name'] ?>" autocomplete="off"/>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="customer_address" name="customer_address" placeholder="Nhập địa chỉ của khách hàng" value="<?php echo $order_data['order']['customer_address'] ?>" autocomplete="off">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="customer_phone" name="customer_phone" placeholder="Nhập số điện thoại khách hàng" value="<?php echo $order_data['order']['customer_phone'] ?>" autocomplete="off">
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                  ...
                  <div class="form-group">
                    <label for="service_charge" class="col-sm-5 control-label">Phí <?php echo $company_data['service_charge_value'] ?> %</label>
                    <div class="col-sm-7">
                  ...
                  <div class="form-group">
                    <label for="net_amount" class="col-sm-5 control-label">Số tiền phải thanh toán</label>
                    <div class="col-sm-7">
                  ...
                  <div class="form-group">
                    <label for="paid_status" class="col-sm-5 control-label">Tình trạng thanh toán</label>
                    <div class="col-sm-7">
              ...
              <div class="box-footer">
                ...
                <a target="__blank" href="<?php echo base_url() . 'orders/printDiv/'.$order_data['order']['id'] ?>" class="btn btn-default" >In đơn hàng</a>
                <button type="submit" class="btn btn-primary">Lưu</button>
                <a href="<?php echo base_url('orders/') ?>" class="btn btn-warning">Quay trở lại</a>
              </div>
            </form>
          <!-- /.box-body -->
        </div>
