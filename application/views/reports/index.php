        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Tổng quát báo cáo</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="chart">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Tổng số đơn đặt hàng phải thanh toán - Dữ liệu báo cáo</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
  ...
  <script type="text/javascript">
    ...
    barChartData.datasets[0].fillColor   = '#00a06a';
    barChartData.datasets[0].strokeColor = '#00a06a';
    barChartData.datasets[0].pointColor  = '#00a06a';
    var barChartOptions                  = {
