      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li id="dashboardMainMenu">
          <a href="<?php echo base_url('dashboard') ?>">
            <i class="fa fa-gg"></i> <span>Bảng Điều Khiển</span>
          </a>
        </li>
        ...
        <?php if($user_permission): ?>
          ...
          <?php if(in_array('createBrand', $user_permission) || in_array('updateBrand', $user_permission) || in_array('viewBrand', $user_permission) || in_array('deleteBrand', $user_permission)): ?>
            <li id="brandNav">
              <a href="<?php echo base_url('brands/') ?>">
                <i class="glyphicon glyphicon-tags"></i> <span>Quản Lý Nhãn Hiệu</span>
              </a>
            </li>
          <?php endif; ?>
          ...
          <?php if(in_array('createStore', $user_permission) || in_array('updateStore', $user_permission) || in_array('viewStore', $user_permission) || in_array('deleteStore', $user_permission)): ?>
            <li id="storeNav">
              <a href="<?php echo base_url('stores/') ?>">
                <i class="fa fa-star"></i> <span>Quản lý Cửa Hàng</span>
              </a>
            </li>
          <?php endif; ?>
          ...
          <li id="attributeNav">
            <a href="<?php echo base_url('attributes/') ?>">
              <i class="fa fa-align-left"></i> <span>Quản Lý Thuộc Tính</span>
            </a>
          </li>
          <?php endif; ?>
          ...
          <?php if(in_array('viewReports', $user_permission)): ?>
            <li id="reportNav">
              <a href="<?php echo base_url('reports/') ?>">
                <i class="glyphicon glyphicon-stats"></i> <span>Quản Lý Báo Cáo</span>
              </a>
            </li>
          <?php endif; ?>
          ...
          <?php if(in_array('updateCompany', $user_permission)): ?>
            <li id="companyNav"><a href="<?php echo base_url('company/') ?>"><i class="fa fa-files-o"></i> <span>Quản Lý Cấu Hình</span></a></li>
          <?php endif; ?>
        ...
        <?php if(in_array('viewProfile', $user_permission)): ?>
          <li><a href="<?php echo base_url('users/profile/') ?>"><i class="fa fa-user-o"></i> <span>Quản Lý Hồ Sơ</span></a></li>
        <?php endif; ?>
